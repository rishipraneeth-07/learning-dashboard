...
export default function ActivityTile() {
  return (
    <motion.article
      ...
      className="relative col-span-1 rounded-2xl p-5 bg-[#110e00] border border-amber-900/20 overflow-hidden"
    >
      <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-amber-600/10 rounded-full blur-2xl pointer-events-none" />
